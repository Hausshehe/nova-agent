...
class LLMPlanner:
    ...
    def _request(self, context: ReasoningContext, previous: Plan | None) -> str:
        ...
        prompt = (
            ...
            "intent MUST advance one of them. High uncertainty means reassess and resolve an unknown; medium means "
            "choose a verifiable action; low means proceed normally.\n"
